 ...
 * not sure how to fix errors in BinaryExp return stmt
 */
package Tokenizer;
...
public class Parser
{
    ...
    private ParseResult parsePrimary(final int startPos) throws ParseException
    {
        ...
        {
            final NumberToken asNumber = (NumberToken) tokenHere;
        ...
        {
            final VariableToken asVariable = (VariableToken) tokenHere;
